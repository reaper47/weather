...
from app.models.sampling import (Station, DHT, Temperature, HeatIndex, DS18B20, FC37, TEMT6000, BME280,
                                 get_samples_for_day, add_new_sample, find_temperature)
...
def test_add_new_sample(a_station, a_dht_sample):
    ...
    bme280 = BME280_Dto(t_c=temperature.celsius, t_f=temperature.fahrenheit, humidity=A_HUMIDITY, pressure=100170)
    ...
    assert BME280.query.all()[-1] == BME280(temperature=temperature, humidity=77.25, pressure=100170, date=date)
